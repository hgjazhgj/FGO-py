...
class XDetectBase(metaclass=logMeta(logger)):
    ...
    def isStoryCross(self):return self._compare(self.tmpl.CROSS,(1231,19,1262,49))
    def isStoryDialog(self):return self._compare(self.tmpl.DIALOGBAR,(154,164,1129,260))
    def isStoryMap(self):return self._compare(self.tmpl.TERMINAL,(8,4,58,83))
    ...
    def findStoryClose(self):return self._find(self.tmpl.STORYCLOSE,(307,530,773,634))
    def findStoryNext(self):return self._find(self.tmpl.NEXT,(0,0,1280,608),threshold=0.03)
    @classmethod
