...
class XDetectBase(metaclass=logMeta(logger)):
    ...
    def isStoryMap(self):return self._compare(self.tmpl.TERMINAL,(0,0,185,90))
    ...
    def findClose(self):return self._find(self.tmpl.CLOSEBUTTON,(295,525,780,640),threshold=0.01)
    def findCross(self):return self._find(self.tmpl.CROSS,(1200,0,1280,75),threshold=0.1)
    def findDialog(self):return self._find(self.tmpl.DIALOGBOX,(145,155,1140,270),threshold=0.1)
    def findFriend(self,img):return self._find(img,(13,166,1233,720))
    def findNext(self):return self._find(self.tmpl.NEXT,(0,0,1280,625),threshold=0.03)
    def findMail(self,img):return self._find(img,(73,166,920,720),threshold=.016)
    def findStart(self):return self._find(self.tmpl.STARTBUTTON,(695,520,985,605),threshold=0.01)
    def findStartQuest(self):return self._find(self.tmpl.STARTQUEST,(695,520,985,605),threshold=0.01)
    @classmethod
