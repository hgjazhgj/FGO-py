...
class XDetectBase(metaclass=logMeta(logger)):
    ...
    def isSkillReady(self,i,j):return not self._compare(self.tmpl.STILL,(35+318*i+88*j,598,55+318*i+88*j,618),.3)
    ...
    def isSynthesisFinished(self):return self._compare(self.tmpl.DECIDEDISABLED,(1035,634,1270,711))
...
class XDetectCN(XDetectBase,metaclass=logMeta(logger)):tmpl=IMG_CN
class XDetectJP(XDetectBase,metaclass=logMeta(logger)):tmpl=IMG_JP
