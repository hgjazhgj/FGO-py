...
class Ui_fgoMainWindow(object):
    def setupUi(self, fgoMainWindow):
        ...
        self.BTN_OLD = QtWidgets.QPushButton(self.widget)
        self.BTN_OLD.setCursor(QtGui.QCursor(QtCore.Qt.CursorShape.PointingHandCursor))
        self.BTN_OLD.setObjectName("BTN_OLD")
        self.LAYOUT_FUNC_BATTLE.addWidget(self.BTN_OLD)
        ...
        self.BTN_OLD.clicked.connect(fgoMainWindow.runOld)
        ...
        fgoMainWindow.setTabOrder(self.TXT_APPLE, self.BTN_OLD)
        fgoMainWindow.setTabOrder(self.BTN_OLD, self.BTN_MAIN)
    ...
    def retranslateUi(self, fgoMainWindow):
        ...
        self.BTN_OLD.setStatusTip(_translate("fgoMainWindow", "旧版战斗"))
        self.BTN_OLD.setText(_translate("fgoMainWindow", "旧版战斗"))
