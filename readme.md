...
ui大概长这样:  
![ui](doc/ui.png)  
这个程序能识别技能和宝具是否可以使用,指令卡颜色克制关系暴击率,无法行动及指令卡封印状态,敌我HP/NP等战斗中用得上或用不上的数据,**可以半路接管战斗**,会依据你的设置比较智能地帮你筛选助战,放技能,放宝具,吃苹果,依据特殊的选卡算法选卡,一次合理设定后可以**无脑通过绝大部分非高难关卡**,实战7-12回合能够刷完无限池终本  
除战斗功能外,还提供以下功能:抽友情池,抽无限池,领邮箱狗粮  
照  着  做  应  该  不  难,尽管这看起来是一个不到1000行的*小项目*,但是你最好把它当成有10000行代码来看待  
